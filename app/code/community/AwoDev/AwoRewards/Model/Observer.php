...
class AwoDev_AwoRewards_Model_Observer {
	...
	// sales_order_payment_pay
		try {
			...
			//Mage::log('reward order tried OK',null,'aworewards.log');
			//Mage::log(print_r($order,1),null,'aworewards.log');
		}
		catch(Exception $e) {
			Mage::log('AwoDev_AwoRewards_Model_Observer::triggerOrder::unsuccessful::'.$e->getMessage());
			//Mage::log('reward order tried unsuccessful',null,'aworewards.log');		
		}
