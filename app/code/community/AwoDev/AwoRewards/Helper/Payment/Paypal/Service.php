...
class AwoDev_AwoRewards_Helper_Payment_Paypal_Service extends AwoDev_AwoRewards_Helper_Payment_Paypal {
    ...
    */
	...
	public function init($serviceName, $serviceBinding, $handlers=array()) {
	...
	public function call($port, $method, $requestObject, $apiCredential = null) {		
		$service = Mage::helper('awodev_aworewards/payment_paypal_apiservice');
		$service->init($port, $this->serviceName, $this->serviceBinding, $this->handlers);
