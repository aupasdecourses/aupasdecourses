...
class Pmainguet_Delivery_IndexController extends Mage_Core_Controller_Front_Action {
	...
	public function setCloseStatus($order){
        ...
        $order->addStatusHistoryComment('Automatically Shipped by PMainguet_Delivery.', false);
