...
if (!$installer->tableExists($tableName)) {
  ...
  $table = $installer->getConnection()->newTable($tableName);
    $table
         ...
         ->addColumn('sum_versement', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array(
          'nullable' => false,
          'default' => '0.0000',
          ), 'Sum Versement TTC')
         ->addColumn('sum_versement_HT', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array(
          'nullable' => false,
          'default' => '0.0000',
          ), 'Sum Versement HT');
...
if (!$installer->tableExists($tableName)) {
  ...
  $table = $installer->getConnection()->newTable($tableName);
    $table
         ...
         ->addColumn('sum_payout_HT', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array(
          'nullable' => false,
          'default' => '0.0000',
          ), 'Sum payout HT')
