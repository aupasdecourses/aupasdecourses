...
require_once(Mage::getModuleDir('controllers','Amasty_Shiprestriction').DS.'Adminhtml/RuleController.php');
 ...
 * @link     http://www.garden-media.fr
 */
class Apdc_Shiprestriction_Adminhtml_RuleController extends Amasty_Shiprestriction_Adminhtml_RuleController
{
