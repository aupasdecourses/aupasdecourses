...
$installer->addAttribute('catalog_category', 'mail_contact', $mailcontact);
//->addAttribute('catalog_category', 'nom_contact', $nomcontact)
// ->addAttribute('catalog_category', 'infos_complementaires', $infocomp)
// ->addAttribute('catalog_category', 'telephone', $telephone)
