...
<action type="dataflow/convert_mapper_column" method="map">
    <var name="map">
        ...
        <map name="vin_type"><![CDATA[vin_type]]></map>
        <map name="vin_couleur"><![CDATA[vin_couleur]]></map>
        <map name="vin_type"><![CDATA[vin_type]]></map>
        <map name="conditionnement"><![CDATA[conditionnement]]></map>
        <map name="vin_region"><![CDATA[vin_region]]></map>
        <map name="vin_appellation"><![CDATA[vin_appellation]]></map>
        <map name="vin_domaine"><![CDATA[vin_domaine]]></map>
        <map name="vin_vigneron"><![CDATA[vin_vigneron]]></map>
        <map name="vin_denomination"><![CDATA[vin_denomination]]></map>
        <map name="vin_millesime"><![CDATA[vin_denomination]]></map>
...
$dataProfile = Mage::getModel('dataflow/profile')->getCollection()->addFieldToFilter('name','Apdc - Export All Products')->getFirstItem();
$dataProfile->setActionsXml($actionsXml)
    ->save();

$dataProfile = Mage::getModel('dataflow/profile')->getCollection()->addFieldToFilter('name','Apdc - Export Referentiel Products')->getFirstItem()->delete();