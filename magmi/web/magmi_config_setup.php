...
<div class="container_12">
	<div class="grid_12 subtitle">
		<span>1 - Synchronize Google Docs CSV</span>
	</div>
</div>
<div class="container_12">
...
<div class="grid_12 col">
		<h3>Update Disabled</h3>
		    <div class="error">Zip library not available, Upgrade/Upload function are not enabled</div>
	</div>
<?php }?>
</div> -->
<div class="container_12">
	<div class="grid_12 subtitle">
		<span> 3 - Run Magmi</span>
<?php if(!$conf_ok){?>
		...
		<div class="grid_12 col" id="directrun">
			...
			<div class="formline">
				...
				<select name="profile" id="runprofile">
					...
					<!-- Changed by Pierre Mainguet 5 janvier 2016 -->
