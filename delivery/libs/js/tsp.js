...
function formatDirections(gdir, mode) {
	...
	retStr += "\t<tr class='heading'><td class='heading' width=40>"
	    + "<div class='centered-directions'><img src='style/images/blackmarker/number_"
	    + number + ".png'></div></td>"
	...
	dragStr += "<li id='" + i + "' class='ui-state-"
	  + (i ? "default" : "disabled") + "'>"
	  + "<table class='dragTable'><tr><td class='left'><img src='style/images/blackmarker/number_"
	...
	dragStr += "<li id='" + 0 + "' class='ui-state-disabled'>"
	  + "<table class='dragTable'><tr><td><img src='style/images/blackmarker/number_"
	  + 1 + ".png' /></td><td>" + headerStr
	  + "</td></tr></table></li>"; 
	retStr += "\t<tr class='heading'><td class='heading'>"
	    + "<div class='centered-directions'><img src='style/images/blackmarker/symbol_blank.png'></div></td>"
	    + "<td class='heading'>"
...
function drawMarker(latlng, addr, label, num) {
    var icon;
    icon = new google.maps.MarkerImage("style/images/redmarker/number_" + (num + 1) + ".png");
...
function onSolveCallback(myTsp) {
  jQuery('#dialogProgress').dialog('close');
	...
	var myIcn1 = new google.maps.MarkerImage("style/images/blackmarker/symbol_blank.png");
	var marker = new google.maps.Marker({ 
            position: myPt1, 
	    icon: myIcn1, 
	    map: gebMap });
	...
	if (i == dir.legs.length - 1 && mode == 0) {
	    myIcn1 = new google.maps.MarkerImage("style/images/blackmarker/number_1.png");
	} else {
	    myIcn1 = new google.maps.MarkerImage("style/images/blackmarker/number_" + (i+2) + ".png");
	}
	var marker = new google.maps.Marker({
            position: myPt1,
	    icon: myIcn1,
