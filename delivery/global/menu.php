...
<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1">
 <?php if (!utilisateur_est_connecte()) {}else{ ?>
  <ul class="nav navbar-nav">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu" role="menu">
          ...
          <li><a href="index.php?module=commande&action=view&option=client">Liste complète (infos clients)</a></li>
          <li><a href="index.php?module=commercant&action=view&option=order">Liste par Commerçant</a></li>
        </ul>
    </li>
    <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Livraison<span class="caret"></span></a>
        <ul class="dropdown-menu" role="menu">
          <li><a href="index.php?module=dispatch&action=view&option=listing">Listing</a></li>
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Virement/Remb.<span class="caret"></span></a>
        <ul class="dropdown-menu" role="menu">
          <li><a href="index.php?module=remboursement&action=view">Clients</a></li>
