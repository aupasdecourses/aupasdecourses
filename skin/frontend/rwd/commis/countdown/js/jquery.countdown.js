...
(function($j){
	...
	function init(elem, options){
		elem.before('<div class="countdown-text">Plus que </div>');
		elem.addClass('countdownHolder');

		// Creating the markup inside the container
		//$j.each(['Days','Hours','Minutes','Seconds'],function(i){
		$j.each(['Days','Hours','Minutes'],function(i){
			$j('<span class="count'+this+'">').html(
				'<span class="position">\
