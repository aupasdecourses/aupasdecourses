...
class Pmainguet_CreateStore extends Mage_Shell_Abstract
{
    ...
    private $_rootcategory = 'Commercants 13e';
    private $_rootcaturlkey = 'commercants-13e';
    private $_codewebsite = 'apdc_13e';
    private $_namewebsite = 'Au Pas De Courses 13e';
    private $_namestoregroup = 'apdc_13e';
    private $_codeboutique = 'paris13e';
    private $_nameboutique = '13e';

    private $_commercant = [
            'Boucher' => 'Boucherie Persillé',
            'Primeur' => 'Primeur de la Butte-Aux-Cailles',
            'Fromager' => 'La Fromagerie Lasnier',
            'Poissonnier' => 'Au Bon Port Jeanne d\'Arc',
            'Caviste' => 'La Cave de Tolbiac',
            'Boulanger' => 'Boulangerie de Tolbiac',
            ];
    ...
    private $_titlehomepage = 'Au Pas De Courses - Livraison de courses Paris 13e';
    private $_metadescription = 'Les livraisons de courses dans le 13e arrondissement avec Au Pas De Courses, pour bien manger avec les meilleurs commerçants de Paris. Essayez ce soir, c\'est facile!';
    private $_content_heading = 'Au Pas De Courses, votre livraison de produits frais dans le 13e';

    private $_shippingruletoduplicate = 'Restriction 13e';
