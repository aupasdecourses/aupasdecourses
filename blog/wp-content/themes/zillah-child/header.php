                        ...
                        <div id="top-menu-flex-parent">
                            <div class="top-menu-element-apdc-logo">
                                ...
                                <a href="https://www.aupasdecourses.com" target="_blank">
                                    <img id="logo-apdc" src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/zillah-child/img/logo-APDC.png" alt="Logo Au Pas de Courses">
                                </a>
                            </div><!--
                            --><div class="top-menu-element-menu">
                                ...
                                <div class="menu-container"><!--
                                 --><label for="menuToggle" id="menu-label-bars">
                                        <img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/zillah-child/img/menu-bars.png" alt="Ouvrir menu">
                                 </label><!--
                                 --><label for="menuToggle" id="menu-label-x">
                                        <img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/zillah-child/img/menu-x.png" alt="Fermer menu">
                                 </label>
                                </div>
                                ...
                                <nav id="sliding-menu" role="navigation">
                                   <div id="blog-logo-wrapper-responsive-menu">
                                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                                            <img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/zillah-child/img/logo-blog.png" alt="Logo du Blog d'AuPasDeCourses"/>
                                       </a>
                                    </div>
                            ...
                            <div>
                                <div id="header-categories-wrapper">
                                    <div class="header-single-category-wrapper">
                                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>category/recettes/">
                                    ...
                                    <div class="header-single-category-wrapper">
                                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>category/decouverte/">
