...
<head>
	...
	<meta name="keywords" content="courses,ecommerce, local, paris, petits commerçants, alimentaire, produits de bouche, artisans, livraison, commis,boucher,primeur,poissonnier,boulanger,fromager,livraison" />
    ...
    <title>Au Pas De Courses - Coming Soon</title>
    ...
    <div class="container">
        <div class="row" style="padding:60px 50px 0;">
            <div class="col-md-6 col-sm-12">
                <div class="logo">
                    <img src="https://www.aupasdecourses.com/skin/frontend/rwd/landing-page/images/logo.png" alt="Au Pas De Courses" class="large">
                    <div id="storename"><?php echo $data[$zipcode]['nom'];?></div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <h1>Dommage ! Nous ne sommes actifs pour le moment qu'en région parisienne.</h1>
                <h3>Vous avez des questions ou des suggestions ? </h3>
				<a class="btn btn-default standard-button ladda-button" style="float: left;" href="javascript:void(Tawk_API.toggle())">Contactez nous !</a>
