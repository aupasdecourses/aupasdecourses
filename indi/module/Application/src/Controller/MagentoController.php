...
class MagentoController extends AbstractActionController
{
	...
	public function getOrdersAction($params = false, $dfrom = null, $dto = null, $commercantId = -1, $orderId = -1) {
		// variables init ===>
		if ($params <> true) {
			$dfrom = $this->params('dfrom');
			$dto = $this->params('dto');
		}
		if (!isset($dfrom))
			$dfrom = date('Y-m-d');
	...
	public function getOrdersByStoreAction($params = false, $dfrom = null, $dto = null, $commercantId = -1, $orderId = -1) {
		// variables init ===>
		if ($params <> true) {
			$dfrom = $this->params('dfrom');
			$dto = $this->params('dto');
	...
	public function getMerchantsOrdersAction($params = false, $commercantId = -1, $dfrom = null, $dto = null) {
		// variables init ===>
		if ($params <> true) {
			$commercantId = $this->params('commercantId');
			$dfrom = $this->params('dfrom');
			$dto = $this->params('dto');
		}
		if (!isset($dfrom))
...
//		echo "<pre>"; print_r($commercants); echo "</pre>";
		return ($commercants);
	}

	public function getMerchantsOrdersbyStoreAction($params = false, $commercantId = -1, $dfrom = null, $dto = null) {
		// variables init ===>
		if ($params <> true) {
			$commercantId = $this->params('commercantId');
			$dfrom = $this->params('dfrom');
